<html>
    <head>
        ...
        <!--Créer un tableau mois et l'initialiser avec les valeurs des mois.-->
        <title>Exercice 1 de la partie 5 en PHP</title>
    </head>
    <body>
        <!--Mise en place d'une balise p pour mettre le script php-->
        <p>
            <?php
// Déclaration d'une variable tableau numéroté nommé month initialisé avec des valeurs  
